 ...
 * Generated at: 2020-08-24 04:52:39 UTC
...
public final class productStateView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("productState.model.vo.ProductState");
    _jspx_imports_classes.add("productCategory.model.vo.ProductCategory");
    _jspx_imports_classes.add("productState.model.vo.ProductRankState");
  }
...
if(memberLoggedIn != null) {
 ...
 if(memberLoggedIn == null){ 
      ...
      out.write("<link rel=\"stylesheet\" href=\"");
      out.print( request.getContextPath() );
      out.write("/css/productStateView.css\" />\r\n");
	...
	List<ProductRankState> rankList = (List<ProductRankState>)request.getAttribute("rankList");
      ...
      out.write("\r\n");
      out.write("    \r\n");
      out.write("<section class=\"graph-section\">\r\n");
      out.write("\t<div id=\"graph-containerS\" >\r\n");
      out.write("\t\t<h2>*브랜드별판매현황*</h2>\t\r\n");
      out.write("\t</div>\r\n");
      out.write("  \r\n");
      out.write("    <!--Div that will hold the pie chart-->\r\n");
      out.write("    <table id=\"productStateS\">\r\n");
      out.write("    <tr>\r\n");
      out.write("    \t<td class=\"myChart_1\">\r\n");
      out.write("    \t\t<canvas id=\"myChart1\" width=\"700\" height=\"400\"></canvas>\r\n");
      out.write("    \t</td>\r\n");
      out.write("\r\n");
      out.write("    \t<td class=\"myChart_2\">\r\n");
      out.write("\t\t\t<canvas id=\"myChart2\" width=\"400\" height=\"600\"></canvas>\r\n");
      out.write("\t\t</td>\r\n");
      out.write("    \r\n");
      out.write("    </tr>\r\n");
      out.write("    <tr>\r\n");
      out.write("    \t<td id=\"chartName1S\">브랜드별 주문 현황</td>\r\n");
      out.write("    \t<td id=\"chartName2S\" >주문량 Top 3</td>\r\n");
      out.write("    </tr>\r\n");
      out.write("\t</table>\r\n");
      out.write("\t\r\n");
      out.write("</section>\r\n");
      ...
      out.write("    <script>\r\n");
      out.write("\t\tvar ctx = document.getElementById('myChart1').getContext('2d');\r\n");
      ...
      out.write("', '");
      out.print( list.get(1).getBrand() );
      out.write("', '");
      out.print( list.get(2).getBrand() );
      out.write("'],\r\n");
      out.write("\t\t        datasets: [{\r\n");
      out.write("\t\t            title: 'best product',\r\n");
      out.write("\t\t            data: [");
      out.print( list.get(0).getPercent() );
      out.write(',');
      out.write(' ');
      out.print( list.get(1).getPercent() );
      out.write(',');
      out.write(' ');
      out.print( list.get(2).getPercent() );
      out.write("],\r\n");
      out.write("\t\t            backgroundColor: [\r\n");
      out.write("\t\t            \t'rgb(220, 020, 060)',\r\n");
      out.write("\t\t            \t'rgb(15, 162, 235)',\r\n");
      out.write("\t\t                'rgb(000, 206, 209)'\r\n");
      out.write("\t\t            ],\r\n");
      out.write("\t\t            borderColor: [\r\n");
      out.write("\t\t            \t'rgba(220, 020, 060, 0.1)',\r\n");
      out.write("\t\t            \t'rgba(15, 162, 235, 0.1)',\r\n");
      out.write("\t\t                'rgba(000, 206, 209, 0.1)'\r\n");
      out.write("\t\t            ],\r\n");
      ...
      out.write("\t\t    data: {\r\n");
      out.write("\t\t        labels: ['");
      out.print( rankList.get(0).getProductName() );
      out.write("', '");
      out.print( rankList.get(1).getProductName() );
      out.write("', '");
      out.print( rankList.get(2).getProductName() );
      out.write("'],\r\n");
      out.write("\t\t        datasets: [{\r\n");
      out.write("\t\t            label: 'best product',\r\n");
      out.write("\t\t            data: [");
      out.print( rankList.get(0).getCount() );
      out.write(',');
      out.write(' ');
      out.print( rankList.get(1).getCount() );
      out.write(',');
      out.write(' ');
      out.print( rankList.get(2).getCount() );
      out.write("],\r\n");
      out.write("\t\t            backgroundColor: [\r\n");
      out.write("\t\t                'rgba(255, 99, 132, 0.3)',\r\n");
      out.write("\t\t                'rgba(154, 050, 204, 0.3)',\r\n");
      out.write("\t\t                'rgba(255, 206, 86, 0.3)'\r\n");
      out.write("\t\t            ],\r\n");
      out.write("\t\t            borderColor: [\r\n");
      out.write("\t\t                'rgba(255, 99, 132, 1)',\r\n");
      out.write("\t\t                'rgba(154, 050, 204, 0.5)',\r\n");
