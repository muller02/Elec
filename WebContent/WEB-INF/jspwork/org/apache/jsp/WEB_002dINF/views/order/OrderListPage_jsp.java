 ...
 * Generated at: 2020-08-24 08:19:52 UTC
...
public final class OrderListPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("order.model.vo.OrderBrand");
    _jspx_imports_classes.add("java.util.List");
    _jspx_imports_classes.add("order.model.vo.OrderList");
    _jspx_imports_classes.add("order.model.vo.OrderListSeller");
    ...
    _jspx_imports_classes.add("javax.sound.midi.MidiDevice.Info");
    _jspx_imports_classes.add("order.model.vo.OrderListInfo");
...
if(memberLoggedIn != null) {
 ...
 if(memberLoggedIn == null){ 
      ...
      out.write("<div id=\"phrasesH\"><p id=\"p1H\" class=\"korFontH\">주문내역</p></div>\r\n");
      out.write("\r\n");
      out.write("   ");
if(memberLoggedIn != null && MemberService.USER_MEMBER_ROLE.equals(memberLoggedIn.getMemberRole())){ 
      out.write("\r\n");
      out.write("\t\t<div>\r\n");
      out.write("\t      \t<ul class=\"ulH\"> \r\n");
      out.write("\t        ");
for(Entry<OrderList, Object> entry : orderMap.entrySet()){ 
      out.write("\r\n");
      out.write("\t\t        <li> \r\n");
      out.write("\t\t\t          <div class=\"dateH\">");
      out.print( entry.getKey().getOrderDate() );
      out.write("</div>\r\n");
      out.write("\t\t\t          <div class=\"hrH\"></div>\r\n");
      out.write("\t\t\t          <ul class=\"ulH\">\r\n");
      out.write("\t\t\t\t            ");
...
for(OrderListInfo info : orderListInfo){
      out.write("\r\n");
      out.write("\t\t\t\t\t            <li>\r\n");
      out.write("\t\t\t\t\t\t              <div class=\"listH\">\r\n");
      out.write("\t\t\t\t\t\t\t              <img src=\"");
      out.print(request.getContextPath() );
      out.print(info.getProductImg() );
      out.write("/thum.png\" alt=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t              <div class=\"prodInfoH\">\r\n");
      out.write("\t\t\t\t\t\t\t              \t");
String inch = info.getInch().equals("0") ? "" : info.getInch()+"inch"; 
 ...
 String productName = info.getProductName() + " " + inch + " " + info.getCapacity()+ " " +info.getColorName();
      out.write("\r\n");
      out.write("\t\t\t\t\t\t                    <div class=\"info1H\"><p class=\"engFontH\" >");
      out.print( productName );
      out.write("</p></div>\r\n");
      out.write("\t\t\t\t\t\t                    <div class=\"info2H\"><p class=\"korFontH\">수량  : ");
      out.print( info.getAmount() );
      out.write("</p></div>\r\n");
      out.write("\t\t\t\t\t\t                     ");
 ...
 totalPrice += price * info.getAmount(); 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t                    <div class=\"info3H\"><p class=\"engFontH\">₩ ");
      out.print( price );
      out.write("</p></div>\r\n");
      out.write("\t\t\t\t\t\t                    <div class=\"lineH\"></div>\r\n");
      out.write("\t\t\t\t\t\t                    <input type=\"hidden\" name=\"hiddenCode\" value=\"");
      out.print( info.getProductCode());
      out.write("\"/>\r\n");
      out.write("\t\t\t\t\t\t                    <input type=\"hidden\" name=\"hiddenInch\" value=\"");
      out.print( info.getInch());
      out.write("\"/>\r\n");
      out.write("\t\t\t\t\t\t                    <button class=\"btnReiviewH\" value=\"");

      out.write("\" onclick=\"review(this);\">리뷰쓰기</button>\r\n");
      out.write("\t\t\t\t\t\t\t              </div>\r\n");
      out.write("\t\t\t\t\t\t            </div>\r\n");
      out.write("\t\t\t\t\t            </li>\r\n");
      out.write("\t\t\t\t\t           <div class=\"hrH\"></div>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t          </ul>\r\n");
      out.write("\t\t\t          <div class=\"totalPriceH\" ><p class=\"totalPH\">Total = ₩ ");
...
String inch = info.getInch().equals("0") ? "" : info.getInch()+"inch"; 
 ...
 String productName = info.getProductName() + " " + inch + " " + info.getCapacity()+ " " +info.getColorName();
      ...
      out.write("\t\t\t          </ul>\r\n");
      out.write("\t\t\t         <div class=\"hrH\"></div>\r\n");
      out.write("\t\t\t         <div id=\"orderInfoH\">\r\n");
      out.write("\t\t\t          <p id=\"orderPH\">주문자 : ");
      out.print( entry.getKey().getMemberId() );
      out.write("</p>\r\n");
      out.write("\t\t\t          <span =\"orderSpanH\">수령자 : ");
      out.print( entry.getKey().getRecipient());
      out.write("</span>\r\n");
      out.write("\t\t\t          <span class=\"orderSpanH\">핸드폰 번호 : ");
      out.print(entry.getKey().getRecipientPhone() );
      out.write("</span>\r\n");
      out.write("\t\t\t          <span class=\"orderSpanH\" >주소 : ");
      out.print( entry.getKey().getAddress() );
      out.write("</span>\r\n");
      out.write("\t\t\t          </div>\r\n");
      out.write("\t        \t</li>\r\n");
      out.write("\t        ");
      ...
      out.write("<script>\t\r\n");
      out.write("\r\n");
      out.write("$(\".btnReiviewH\").click(function(){\r\n");
      out.write("\tvar code = $(this).parent().children('input[name=hiddenCode]').attr('value');\r\n");
      out.write("\tconsole.log(code);\r\n");
      out.write("\t\r\n");
      out.write("\tvar inch = $(this).parent().children('input[name=hiddenInch]').attr('value');\r\n");
      out.write("\tconsole.log(inch);\r\n");
      out.write("\t\r\n");
      out.write("\tvar rvo = \"on\";\r\n");
      out.write("\tlocation.href = \"");
      out.print( request.getContextPath());
      out.write("/product/productview?productCode=\" + code + \"&inch=\" + inch + \r\n");
      out.write("\t\t\t\"&rvo=\" + rvo; \r\n");
      out.write("});\r\n");
      out.write("</script>  \r\n");
      out.write("    \r\n");
