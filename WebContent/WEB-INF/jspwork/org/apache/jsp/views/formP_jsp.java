 ...
 * Generated at: 2020-08-23 16:11:50 UTC
...
public final class formP_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(memberLoggedIn != null) {
 ...
 if(memberLoggedIn == null){ 
      ...
      out.write("        var add = document.getElementById(\"waitingB\");\r\n");
      out.write("        var html = '<input type=\"text\" name=\"option\" id=\"op'+i+'\">';\r\n");
      out.write("        \r\n");
      out.write("        if(i !=6){\r\n");
      out.write("            add.innerHTML += html + \"<br/>\";\r\n");
      out.write("            i++;\r\n");
      out.write("         }\r\n");
      out.write("\r\n");
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("    $(\"[name=registB]\").submit(function(){\r\n");
      out.write("    \t\r\n");
      out.write("        if(confirm(\"제품을 등록하시겠습니까?\")){\r\n");
      out.write("            return true;\r\n");
      out.write("        }\r\n");
      out.write("        else{\r\n");
      out.write("            return false;\r\n");
      ...
      out.write("});\r\n");
      out.write("\r\n");
      out.write("    function view(e) {\r\n");
      out.write("        $(\"#discountView\").html(e.value + \"%\");\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("\r\n");
      out.write("    $(document).ready(function(){\r\n");
      out.write("        \t$(\"[name=color]\").on(\"click\", function(){\r\n");
      out.write("                var cnt = $(\"[name=color]:checked\").length;\r\n");
      out.write("                if(cnt>4){\r\n");
      out.write("                    console.log(this);\r\n");
      out.write("                    $(this).prop(\"checked\", false);\r\n");
      out.write("                    alert(\"색상은 4개까지 선택할 수 있습니다.\");\r\n");
      out.write("                }\r\n");
      out.write("        \t});\r\n");
      out.write("        \t\r\n");
      out.write("        });\r\n");
      out.write("    \r\n");
      out.write("    $(document).ready(function(){\r\n");
      out.write("        $(\"[name=capacity]\").change(function(){\r\n");
      out.write("            console.log($(this));\r\n");
      out.write("            $(this).next().next().css(\"display\", \"inline-block\");\r\n");
      out.write("\r\n");
      out.write("            $(\"[name=capacity]\").not(\":checked\").next().next().css(\"display\", \"none\");\r\n");
      out.write("        });\r\n");
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write(" \t\t<img src=\"");
      out.print(request.getContextPath() );
      out.write("/images/DJ/st1.jpg\" class=\"imBB\">\r\n");
      out.write("\r\n");
      out.write("        <form action=\"");
      out.print( request.getContextPath() );
      out.write("/seller/form\" \r\n");
      out.write("        method=\"POST\" \r\n");
      out.write("        name=\"registB\"\r\n");
      out.write("        style=\"height:880px;\">\r\n");
      out.write("           <div class=\"navvB\">\r\n");
      out.write("            <br>\r\n");
      out.write("            <label for=\"productName\" class=\"labelB\">상품명 : </label>\r\n");
      out.write("            <input type=\"text\" name=\"productName\" placeholder=\"핸드폰 상품명\">\r\n");
      out.write("            \r\n");
      out.write("\t         <input type=\"hidden\" name=\"category\" value=\"P\"/>\r\n");
      ...
      out.write("            <br>\r\n");
      out.write("           \r\n");
      out.write("            <label for=\"color\" class=\"labelB\">색상 : </label>\r\n");
      out.write("            <input type=\"checkbox\" name=\"color\" id=\"c1\" value=\"c1\">\r\n");
      out.write("            <label for=\"c1\">블랙</label>\r\n");
      out.write("            <input type=\"checkbox\" name=\"color\" id=\"c2\" value=\"c2\" style=\"margin-left:22px;\">\r\n");
      out.write("            <label for=\"c2\">레드</label>\r\n");
      out.write("            <input type=\"checkbox\" name=\"color\" id=\"c5\" value=\"c5\" style=\"margin-left:22px;\">\r\n");
      out.write("            <label for=\"c5\">그린</label>\r\n");
      out.write("            <br>\r\n");
      out.write("            <input type=\"checkbox\" name=\"color\" id=\"c6\" value=\"c6\"  style=\"margin-left: 145px;\">\r\n");
      out.write("            <label for=\"c6\">그레이</label>\r\n");
      out.write("            <input type=\"checkbox\" name=\"color\" id=\"c7\" value=\"c7\">\r\n");
      out.write("            <label for=\"c7\">화이트</label>\r\n");
      out.write("            <input type=\"checkbox\" name=\"color\" id=\"c9\" value=\"c9\">\r\n");
      out.write("            <label for=\"c9\">퍼플</label>\r\n");
      out.write("            <br>\r\n");
      out.write("            <input type=\"checkbox\" name=\"color\" id=\"c11\" value=\"c11\" style=\"margin-left: 145px;\">\r\n");
      out.write("            <label for=\"c11\">골드</label>\r\n");
      out.write("            \r\n");
      out.write("\r\n");
      out.write(" \t\t\t <br>\r\n");
      out.write(" \t\t\t <br>\r\n");
      out.write("            <label for=\"capacity\" class=\"labelB\">저장용량 : </label>\r\n");
      out.write("            <input type=\"checkbox\" name=\"capacity\" value=\"32GB\">\r\n");
      out.write("            <label for=\"32\">32GB</label>\r\n");
      out.write("            <input type=\"number\" name=\"price\" placeholder=\"가격입력\" style=\"display: none; width: 100px; margin-left:22px;\">\r\n");
      out.write("            <br />\r\n");
      out.write("            <input type=\"checkbox\" name=\"capacity\" value=\"64GB\" style=\"margin-left: 192px;\" >\r\n");
      out.write("            <label for=\"64\">64GB</label>\r\n");
      out.write("            <input type=\"number\" name=\"price\" placeholder=\"가격입력\" style=\"display: none; width: 100px; margin-left:22px;\">\r\n");
      out.write("            <br />\r\n");
      out.write("            <input type=\"checkbox\" name=\"capacity\" value=\"256GB\" style=\"margin-left: 192px;\">\r\n");
      out.write("            <label for=\"256\">256GB</label>\r\n");
      out.write("            <input type=\"number\" name=\"price\" placeholder=\"가격입력\" style=\"display: none; width: 100px;\">\r\n");
      out.write("            <br>\r\n");
      out.write("            <input type=\"checkbox\" name=\"capacity\"  value=\"512GB\" style=\"margin-left: 192px;\">\r\n");
      out.write("            <label for=\"512\">512GB</label>\r\n");
      out.write("            <input type=\"number\" name=\"price\" placeholder=\"가격입력\" style=\"display: none; width: 100px;\">\r\n");
      out.write("            <br>\r\n");
      out.write("            <br>\r\n");
      out.write("            <label for=\"discountRate\" class=\"labelB\">할인율</label>\r\n");
      out.write("            <input type=\"range\" min=\"1\" max=\"5\" step=\"1\" name=\"discountRate\" id=\"discountRate\" value=\"0\" onchange=\"view(this);\" required>\r\n");
      out.write("            <div id=\"discountView\" style=\"display: inline;\">1%</div>\r\n");
      out.write("            <br>\r\n");
      out.write("            <br>\r\n");
      out.write("\r\n");
      out.write("            <label for=\"description\" class=\"labelB\">기타 옵션 : </label>\r\n");
      out.write("            <input type=\"text\" name=\"option\" id=\"op0\" required> <input type=\"button\" value=\"추가\" id=\"addB\">\r\n");
      out.write("            <div id=\"waitingB\"></div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("            <button type=\"submit\" class=\"subB\">등록</button>\r\n");
      out.write("\r\n");
      out.write("\t</div>\r\n");
      out.write("\r\n");
      out.write("        </form>\r\n");
