            ...
            <div id="first-boxJ">
                <div id="left-lineJ">
                    <div id="imgSectionJ">
                        ...
                        <h2 id="productNameJ"><%= productInfo.getProductName() %> <%= productInfo.getInch() %></h2>
                ...
                <div id="right-lineJ">
                    ...
                    <div id="hrJ"></div>
                    <div id="capacityNotebookOptionJ">
            ...
            <div id="third-boxJ">
                    ...
                    <div id="inputReviewJ">
                       ...
                       <div id="box1J"><span class="korBoldJ">리뷰작성하기</span></div>
                       	...
                       	<div id="box3J">
		                    ...
		                    <input type="hidden" value="" name="reviewGrade" id="reviewGradeJ" value=""/>
                ...
                <% for(int i=0; i<otherProducts.size(); i++){%>
                    ...
                    <div  class="prodBoxJ">
                        ...
                        <h2 class="prodBoxNameJ"><%= pi.getProductName() %> <%= pi.getInch() %></h2>
